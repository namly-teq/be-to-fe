...
This course is your practical bridge from "I understand React" to "I can work on a real TEQ frontend project." It covers the toolchain that every TEQ frontend developer uses daily — the same setup you will encounter when you open a real project repository.
</Aside>
...
For any new TEQ project, run `teq-superplate` first. You will get all Module 1 and 2 configurations out of the box — no manual setup required.
</Aside>
